...
> **编码器速度噪声不是编码器坏了，而是“用离散脉冲去做微分”这一操作，本身就会制造噪声。滤波不是锦上添花，而是速度计算里不可缺的一步。**除了本文主要介绍的旋转增量光电编码器，实际实验和工程中还会遇到其他类型的编码器。下面分享一些应用经验，供用户参考：
...
![](images-part/PART-ENCODER-8.png)
